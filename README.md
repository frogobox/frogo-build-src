...
```kotlin
const val recyclerViewVersion = "4.3.2" // https://github.com/amirisback/frogo-recycler-view
const val admobVersion = "5.1.4" // https://github.com/amirisback/frogo-admob
const val uiVersion = "1.1.1" // https://github.com/frogobox/frogo-ui
const val sdkVersion = "2.1.0" // https://github.com/frogobox/frogo-sdk
const val consumeApiVersion = "2.4.2" // https://github.com/frogobox/frogo-consume-api
